...
/** Leitura Tarot Brasil via PIX — cobrado em reais (1 € × taxa, arredondado). */
export const PRECO_TAROT_BR_PIX_BRL = Math.round(PRECO_TAROT_BR_PIX_EUR_REF * PIX_BR_EUR_TO_BRL)
