export default {
  ...
  pagamento: {
    ...
    methodsTitle: 'Available methods (by region)',
    redirecting: '⏳ Redirecting to Stripe…',
    payBtn: 'Pay {valor} € — Stripe Checkout',
    methodsFootnote: 'MB Way, Multibanco, PayPal and PIX appear automatically if active on your Stripe account and available in your country.',
