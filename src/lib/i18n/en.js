export default {
  ...
  mapa: {
    ...
    interpTitle: '✦ Professional Interpretation · Ephemerides · Placidus',
  ...
  ferramentasPremium: {
    ...
    sinastria: {
      ...
      subtitlePro: 'Professional synastry — Swiss Ephemeris (JPL/NASA) and cross-aspects (6° orb)',
      ...
      aspectsDetected: 'Aspects detected (Swiss Ephemeris)',
      ...
      premiumItem5: 'Composite Chart — the couple\'s mathematical soul (midpoints)',
