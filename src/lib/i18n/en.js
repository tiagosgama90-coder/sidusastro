export default {
  ...
  pagamento: {
    ...
    methodNotSubscription: 'This method is not available for subscriptions. Use card, PayPal or Link.',
    subscriptionMethodsNote: 'Monthly subscription: card, PayPal or Link. MB Way, Multibanco and PIX are one-time payments only.',
    methodsFootnote: 'You will be redirected to Stripe with your chosen method. Available methods depend on your region and Stripe account.',
    ...
    methods: {
      ...
      pix: { nome: 'PIX', desc: 'Brazil — when available in your region' },
      link: { nome: 'Link / Apple Pay / Google Pay', desc: 'Fast Stripe Checkout' },
    },
  },
  recaptcha: {
