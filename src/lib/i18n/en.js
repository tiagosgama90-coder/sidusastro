export default {
  ...
  vipPromo: {
    ...
    lead: 'Create a post, story or video about Sidusastro, tag @sidusastro on Instagram or TikTok, and get lifetime VIP — free. Review within 48 hours.',
    officialTitle: 'Official Sidusastro accounts (tag us)',
    officialLead: 'Tag or mention @sidusastro in your post so we see your request. Official accounts:',
    officialNote: 'Post on your own profile, but tag @sidusastro in the caption, story or video. Without that we cannot verify your promo.',
    ...
    formHint: 'Post on your profile, tag @sidusastro, and paste your post link here. Requests without @sidusastro or sidusastro.com are rejected.',
    platform: 'Where you posted',
    handle: 'Your @ (your account)',
    handleHint: 'The profile where you published — not the official @sidusastro.',
