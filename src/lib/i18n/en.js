export default {
  ...
  vipPromo: {
    ...
    lead: 'Create a post, story or video about Sidusastro and get lifetime VIP access — free. Manual review within 48 hours.',
    ...
    guarantees: {
      ...
      g3: 'Your content stays yours; we only ask for an honest mention of sidusastro.com.',
    ...
    steps: {
      ...
      s2Title: 'Mention the site',
      s2Text: 'Include sidusastro.com in the caption or bio. You can use our script below.',
      s3Title: 'Submit your request',
      s3Text: 'Fill in the form with your post link and social handle.',
      s4Title: 'Get VIP',
    ...
    videoScript: '"I discovered Sidusastro — free natal chart with real accuracy, tarot tied to your sign and an AI oracle that knows your Sun, Moon and Ascendant. I tried my chart and was impressed. If you love astrology, try it: sidusastro.com — link in bio."',
    captionHint: 'Suggested caption: "Free natal chart + tarot & AI oracle ✦ Try at sidusastro.com (link in bio)"',
    hashtags: '#astrology #natalchart #tarot #horoscope #sidusastro',
    ...
    rejected: 'This request was not approved. Make sure the post is live, mentions sidusastro.com, and try again.',
    tryAgain: 'Submit new request',
    formTitle: 'Submit VIP request',
    formHint: 'The post must be live and accessible. Spam or irrelevant content is rejected.',
    platform: 'Social network',
    handle: 'Username / @',
    handlePlaceholder: 'e.g. @your_profile',
