export default {
  ...
  ferramentasPremium: {
    ...
    sinastria: {
      ...
      subtitlePro: 'Professional synastry — exact positions via Swiss Ephemeris and cross-aspects (6° orb)',
      ...
      birthHint: 'Exact time and place are essential for Mercury, Venus, Mars and Ascendant.',
      ...
      uniqueBond: 'A unique bond that defies categories. Astrology sees potential where there is work and intention.',
