...
const FERRAMENTAS_PT = [
  ...
  { id: 'numerologia', nome: 'Mapa de Numerologia', sub: 'L. Dow Balliett', icon: Sparkles, premium: true },
...
const FERRAMENTAS_EN = [
  ...
  { id: 'numerologia', nome: 'Numerology Chart', sub: 'L. Dow Balliett', icon: Sparkles, premium: true },
...
const BENEFICIOS_VIP_PT = [
  ...
  'Mapa de Numerologia Balliett com ponte astrológica',
...
const BENEFICIOS_VIP_EN = [
  ...
  'Balliett Numerology Chart with astrological bridge',
