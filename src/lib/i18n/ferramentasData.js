import { Compass, Heart, Activity, BookOpen, Moon, FileDigit, Clock } from 'lucide-react'
...
const FERRAMENTAS_PT = [
  ...
  { id: 'numerologia', nome: 'Numerologia', sub: 'Vibração espiritual do nome', icon: FileDigit, premium: true },
...
const FERRAMENTAS_EN = [
  ...
  { id: 'numerologia', nome: 'Numerology', sub: 'Spiritual name vibration', icon: FileDigit, premium: true },
...
const FERRAMENTAS_ES = [
  ...
  { id: 'numerologia', nome: 'Numerología', sub: 'Vibración espiritual del nombre', icon: FileDigit, premium: true },
...
const FERRAMENTAS_IT = [
  ...
  { id: 'numerologia', nome: 'Numerologia', sub: 'Vibrazione spirituale del nome', icon: FileDigit, premium: true },
...
const FERRAMENTAS_DE = [
  ...
  { id: 'numerologia', nome: 'Numerologie', sub: 'Spirituelle Namensschwingung', icon: FileDigit, premium: true },
...
const FERRAMENTAS_FR = [
  ...
  { id: 'numerologia', nome: 'Numérologie', sub: 'Vibration spirituelle du nom', icon: FileDigit, premium: true },
