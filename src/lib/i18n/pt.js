export default {
  ...
  vipPromo: {
    ...
    lead: 'Cria um post, story ou vídeo sobre o Sidusastro, marca @sidusastro no Instagram ou TikTok, e recebe VIP vitalício — sem pagar. Revisão em até 48 horas.',
    officialTitle: 'Contas oficiais Sidusastro (marca-nos)',
    officialLead: 'Na publicação, marca ou menciona @sidusastro para o pedido chegar à equipa. O Instagram e TikTok oficiais são:',
    officialNote: 'Publica no teu perfil, mas marca @sidusastro na legenda, story ou vídeo. Sem isso não conseguimos ver o teu pedido nas redes.',
    ...
    formHint: 'Publica no teu perfil, marca @sidusastro, e cola aqui o link da publicação. Pedidos sem menção a @sidusastro ou sidusastro.com são recusados.',
    platform: 'Onde publicaste',
    handle: 'O teu @ (a tua conta)',
    handleHint: 'O perfil onde fizeste a publicação — não o @sidusastro oficial.',
