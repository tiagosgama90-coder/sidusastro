export default {
  ...
  tarot: {
    ...
    thenPaid: ' · 2 € por leitura ou Premium 9,99 € vitalício',
    ...
    price: '2,00 €',
    paywallText: 'Já usaste as tuas {max} leituras gratuitas de Tarot. Paga 2 € por esta leitura ou activa o Sidus Premium (9,99 €, pagamento único) para Tarot ilimitado + Mapa Astral completo.',
    payOne: '💳 Pagar 2 € · Uma leitura',
    premiumBtn: '✦ Sidus Premium 9,99 € · Tudo incluído',
