export default {
  ...
  pagamento: {
    ...
    methodsTitle: 'Métodos disponíveis (conforme região)',
    redirecting: '⏳ A redirecionar para Stripe…',
    payBtn: 'Pagar {valor} € — Stripe Checkout',
    methodsFootnote: 'MB Way, Multibanco, PayPal e PIX aparecem automaticamente se estiverem activos na tua conta Stripe e disponíveis para o teu país.',
