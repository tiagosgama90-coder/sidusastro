export default {
  ...
  ferramentasPremium: {
    ...
    sinastria: {
      ...
      subtitlePro: 'Sinastria profissional — efemérides Swiss Ephemeris (JPL/NASA) e aspectos cruzados (orbe 6°)',
      ...
      aspectsDetected: 'Aspectos detectados (Swiss Ephemeris)',
      ...
      premiumItem5: 'Mapa Composto — a alma matemática do casal (pontos médios)',
