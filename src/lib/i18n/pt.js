export default {
  ...
  ferramentasPremium: {
    ...
    sinastria: {
      ...
      subtitlePro: 'Sinastria profissional — posições exactas via Swiss Ephemeris e aspectos cruzados (orbe 6°)',
      ...
      birthHint: 'A hora e o local exactos são essenciais para Mercúrio, Vénus, Marte e Ascendente.',
