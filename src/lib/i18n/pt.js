export default {
  ...
  pagamento: {
    ...
    methodNotSubscription: 'Este método não está disponível para subscrições. Usa cartão, PayPal ou Link.',
    subscriptionMethodsNote: 'Subscrição mensal: cartão, PayPal ou Link. MB Way, Multibanco e PIX só para pagamentos únicos.',
    methodsFootnote: 'Serás redireccionado/a para o Stripe com o método escolhido. Os métodos activos dependem da tua região e conta Stripe.',
    ...
    methods: {
      ...
      pix: { nome: 'PIX', desc: 'Brasil — quando disponível na tua região' },
      link: { nome: 'Link / Apple Pay / Google Pay', desc: 'Checkout rápido Stripe' },
    },
  },
  recaptcha: {
