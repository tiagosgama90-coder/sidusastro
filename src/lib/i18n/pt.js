export default {
  ...
  auth: {
    ...
    accountCreated: 'Conta criada! Enviámos um e-mail de confirmação — verifica a caixa de entrada (e spam) antes de continuar.',
  ...
  tarot: {
    ...
    thenPaid: ' · 2 € por leitura ou Premium 4,99 €/mês',
    ...
    price: '2,00 €',
    paywallText: 'Já usaste as tuas {max} leituras gratuitas de Tarot. Paga 2 € por esta leitura ou activa o Sidus Premium (4,99 €/mês) para Tarot ilimitado + Mapa Astral completo em PDF.',
    payOne: '💳 Pagar 2 € · Uma leitura',
    premiumBtn: '✦ Sidus Premium 4,99 €/mês · Mapa completo + Tarot ilimitado',
