export default {
  ...
  vipPromo: {
    ...
    lead: 'Publica no teu perfil (marca @sidusastro), depois envia o pedido nesta página — não por DM. VIP vitalício após aprovação, revisão em até 48 horas.',
    officialTitle: 'Contas oficiais para marcar na publicação',
    officialLead: 'Quando publicares no teu perfil, marca @sidusastro na legenda, story ou vídeo — para a equipa encontrar o teu conteúdo. Não é aqui que envias o pedido.',
    officialNote: 'Estas são as nossas contas no Instagram e TikTok. O pedido de VIP envia-se só pelo formulário abaixo, nesta página.',
    ...
    steps: {
      ...
      s3Title: 'Envia o pedido nesta página',
      s3Text: 'Volta a sidusastro.com/divulgacao-vip e preenche o formulário com o link da tua publicação e o teu @. Não envies por DM.',
      s4Title: 'Recebe VIP',
    ...
    videoScript: '«Descobri o Sidusastro — mapa astral gratuito com precisão real, tarot ligado ao teu signo e um oráculo de IA que conhece o teu Sol, Lua e Ascendente. Experimentei o meu mapa e adorei. Se gostas de astrologia: sidusastro.com — marca @sidusastro!»',
    captionHint: 'Legenda sugerida: «Mapa astral grátis + tarot e oráculo IA ✦ sidusastro.com · @sidusastro»',
    hashtags: '#astrologia #mapaastral #tarot #horoscopo #sidusastro @sidusastro',
    ...
    formTitle: 'Formulário de pedido VIP (aqui no site)',
    formNoticeTitle: 'O pedido envia-se aqui — não por Instagram',
    formNoticeText: 'Este formulário é a única forma de pedir VIP. Não envies mensagem nem pedido por DM no @sidusastro. Primeiro publica no teu perfil (com @sidusastro na publicação); depois cola aqui o link e os teus dados.',
    formHint: 'Os campos abaixo são sobre a tua publicação e a tua conta — não sobre o Instagram do Sidusastro.',
    formSectionYourPost: 'A tua publicação',
    platform: 'Rede onde publicaste (a tua conta)',
    handle: 'O teu @ de utilizador',
    handleHint: 'O @ do perfil onde publicaste — ex.: @maria_astrologia. Não escrevas @sidusastro aqui.',
    handlePlaceholder: 'ex: @maria_astrologia',
    followers: 'Seguidores (opcional)',
    followersPlaceholder: 'ex: 1200',
    postUrl: 'Link da tua publicação',
    postUrlHint: 'Copia o link do post/reel/story (tem de abrir sem login).',
