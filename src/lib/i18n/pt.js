export default {
  ...
  vip: {
    ...
    priceBrPixNote: 'Oferta Brasil · 5 € com PIX (R$ 27)',
  ...
  vipPromo: {
    badge: 'Programa Parceiros Sidus',
    title: 'Ganha Sidus VIP ao divulgar',
    lead: 'Cria um post, story ou vídeo sobre o Sidusastro e recebe acesso VIP vitalício — sem pagar. Revisão manual em até 48 horas.',
    ...
    guarantees: {
      ...
      g3: 'O teu conteúdo mantém-se teu; só pedimos menção honesta ao sidusastro.com.',
    ...
    steps: {
      ...
      s2Title: 'Menciona o site',
      s2Text: 'Inclui o link sidusastro.com na legenda ou bio. Podes usar o nosso guião abaixo.',
      s3Title: 'Envia o pedido',
      s3Text: 'Preenche o formulário com o link da publicação e a tua rede social.',
      s4Title: 'Recebe VIP',
      s4Text: 'Após aprovação, o VIP activa-se na tua conta automaticamente — mapa completo, tarot e oráculo ilimitados.',
    },
    videoGuideTitle: 'Guião para vídeo ou post (clica para ver)',
    videoGuideIntro: 'Podes ler isto à frente da câmara ou adaptar com as tuas palavras. 30–60 segundos chegam.',
    videoScript: '«Descobri o Sidusastro — mapa astral gratuito com precisão real, tarot ligado ao teu signo e um oráculo de IA que conhece o teu Sol, Lua e Ascendente. Experimentei o meu mapa e fiquei impressionado/a. Se gostas de astrologia, vale a pena: sidusastro.com — link na bio.»',
    captionHint: 'Legenda sugerida: «Mapa astral grátis + tarot e oráculo IA ✦ Experimenta em sidusastro.com (link na bio)»',
    hashtags: '#astrologia #mapaastral #tarot #horoscopo #sidusastro',
    ...
    rejected: 'Este pedido não foi aprovado. Verifica se a publicação está online, menciona sidusastro.com e tenta de novo.',
    tryAgain: 'Enviar novo pedido',
    formTitle: 'Enviar pedido de VIP',
    formHint: 'A publicação tem de estar online e acessível. Contas com spam ou conteúdo irrelevante são recusadas.',
    platform: 'Rede social',
    handle: 'Nome de utilizador / @',
    handlePlaceholder: 'ex: @teu_perfil',
    followers: 'Seguidores (opcional)',
    followersPlaceholder: 'ex: 1200',
    postUrl: 'Link da publicação',
    message: 'Mensagem para a equipa',
    messagePlaceholder: 'Conta o que publicaste, porquê recomendas o Sidus, e qualquer detalhe útil (mín. 40 caracteres)…',
  ...
  brasil: {
    ...
    banner: '🇧🇷 Brasileiros: Sidus VIP por 5 € com PIX (R$ 27) — acesso vitalício ao cosmos completo.',
    premiumNote: 'Oferta especial Brasil: 5 € com PIX (R$ 27). Cartão e PayPal: 9,99 €.',
  },
}
