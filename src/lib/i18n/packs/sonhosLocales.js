...
export const CHIPS_ES = ["Agua","Casa","Muerte","Volar","Caída","Animal","Oscuridad","Fuego","Persecución","Niño"]
export const CHIPS_IT = ["Acqua","Casa","Morte","Volare","Caduta","Animale","Oscurità","Fuoco","Inseguimento","Bambino"]
export const CHIPS_DE = ["Wasser","Haus","Tod","Fliegen","Sturz","Tier","Dunkelheit","Feuer","Verfolgung","Kind"]
export const CHIPS_FR = ["Eau","Maison","Mort","Voler","Chute","Animal","Obscurité","Feu","Poursuite","Enfant"]
