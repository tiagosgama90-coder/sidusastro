...
const VENUS_REL = {
  Carneiro: s6("desperta paixão directa, conquista com ousadia e prefere intensidade a jogos prolongados", "awakens direct passion, conquers boldly and prefers intensity over prolonged games", "despierta pasión directa, conquista con audacia y prefiere la intensidad a los juegos prolongados", "risveglia passione diretta, conquista con audacia e preferisce l'intensità ai giochi prolungati", "weckt direkte Leidenschaft, erobert kühn und bevorzugt Intensität gegenüber langen Spielen", "éveille une passion directe, conquiert avec audace et préfère l'intensité aux jeux prolongés"),
  Touro: s6("expressa amor através do corpo, do conforto e da constância sensorial", "expresses love through body, comfort and sensory constancy", "expresa amor a través del cuerpo, la comodidad y la constancia sensorial", "esprime amore attraverso il corpo, il comfort e la costanza sensoriale", "drückt Liebe durch Körper, Komfort und sinnliche Beständigkeit aus", "exprime l'amour par le corps, le confort et une constance sensorielle"),
  Gémeos: s6("seduz com palavras, humor e variedade intelectual", "seduces with words, humour and intellectual variety", "seduce con palabras, humor y variedad intelectual", "seduce con parole, umorismo e varietà intellettuale", "verführt mit Worten, Humor und intellektueller Vielfalt", "séduit par les mots, l'humour et la variété intellectuelle"),
  Caranguejo: s6("ama com profundidade protectora, precisa de segurança emocional para se entregar", "loves with protective depth, needs emotional safety to surrender", "ama con profundidad protectora, necesita seguridad emocional para entregarse", "ama con profondità protettiva, ha bisogno di sicurezza emotiva per abbandonarsi", "liebt mit schützender Tiefe, braucht emotionale Sicherheit zum Hingeben", "aime avec une profondeur protectrice, a besoin de sécurité émotionnelle pour se livrer"),
  ...
  Peixes: s6("idealiza o amor, funde-se emocionalmente e busca romance espiritual", "idealises love, merges emotionally and seeks spiritual romance", "idealiza el amor, se fusiona emocionalmente y busca romance espiritual", "idealizza l'amore, si fonde emotivamente e cerca un romanticismo spirituale", "idealisiert Liebe, verschmilzt emotional und sucht spirituelle Romantik", "idéalise l'amour, fusionne émotionnellement et cherche un romantisme spirituel"),
}

const MARTE_REL = {
  Carneiro: s6("actua com impulso, desejo rápido e iniciativa sexual directa", "acts with impulse, quick desire and direct sexual initiative", "actúa con impulso, deseo rápido e iniciativa sexual directa", "agisce con impulso, desiderio rapido e iniziativa sessuale diretta", "handelt impulsiv, mit schnellem Verlangen und direktiver sexueller Initiative", "agit avec impulsion, désir rapide et initiative sexuelle directe"),
  Touro: s6("persiste no prazer, ritmo lento e sensualidade prolongada", "persists in pleasure, slow rhythm and prolonged sensuality", "persiste en el placer, ritmo lento y sensualidad prolongada", "persiste nel piacere, ritmo lento e sensualità prolungata", "beharrlich im Genuss, langsames Tempo und ausgedehnte Sinnlichkeit", "persiste dans le plaisir, rythme lent et sensualité prolongée"),
  Gémeos: s6("estimula-se com conversa, variedade e provocação mental", "gets aroused through talk, variety and mental provocation", "se excita con la conversación, la variedad y la provocación mental", "si eccita con la conversazione, la varietà e la provocazione mentale", "wird durch Gespräch, Abwechslung und mentale Provokation erregt", "s'excite par la conversation, la variété et la provocation mentale"),
  Caranguejo: s6("defende quem ama, luta por segurança emocional e lar", "defends who they love, fights for emotional safety and home", "defiende a quien ama, lucha por la seguridad emocional y el hogar", "difende chi ama, combatte per la sicurezza emotiva e la casa", "verteidigt Geliebte, kämpft für emotionale Sicherheit und Zuhause", "défend ceux qu'il aime, se bat pour la sécurité émotionnelle et le foyer"),
  Leão: s6("conquista com carisma, orgulho e necessidade de ser desejado", "conquers with charisma, pride and need to be desired", "conquista con carisma, orgullo y necesidad de ser deseado", "conquista con carisma, orgoglio e bisogno di essere desiderato", "erobert mit Charisma, Stolz und dem Bedürfnis, begehrt zu werden", "conquiert avec charisme, fierté et besoin d'être désiré"),
  Virgem: s6("canaliza energia com precisão, pode ser crítico quando frustrado", "channels energy with precision, can be critical when frustrated", "canaliza energía con precisión, puede ser crítico cuando está frustrado", "canalizza energia con precisione, può essere critico quando frustrato", "lenkt Energie präzise, kann kritisch sein wenn frustriert", "canalise l'énergie avec précision, peut être critique quand frustré"),
  Balança: s6("evita conflito directo, mas reage quando a justiça é violada", "avoids direct conflict, but reacts when justice is violated", "evita el conflicto directo, pero reacciona cuando se viola la justicia", "evita il conflitto diretto, ma reagisce quando la giustizia è violata", "meidet direkten Konflikt, reagiert aber wenn Gerechtigkeit verletzt wird", "évite le conflit direct, mais réagit quand la justice est bafouée"),
  Escorpião: s6("intensidade magnética, ciúme profundo, resistência emocional extrema", "magnetic intensity, deep jealousy, extreme emotional stamina", "intensidad magnética, celos profundos, resistencia emocional extrema", "intensità magnetica, gelosia profonda, resistenza emotiva estrema", "magnetische Intensität, tiefe Eifersucht, extreme emotionale Ausdauer", "intensité magnétique, jalousie profonde, endurance émotionnelle extrême"),
  Sagitário: s6("aventureiro, honesto demais, foge de possessividade", "adventurous, overly honest, runs from possessiveness", "aventurero, demasiado honesto, huye de la posesividad", "avventuroso, troppo onesto, fugge dalla possessività", "abenteuerlustig, zu ehrlich, flieht vor Besitzdenken", "aventurier, trop honnête, fuit la possessivité"),
  Capricórnio: s6("controlado, estratégico, liberta paixão apenas com confiança", "controlled, strategic, releases passion only with trust", "controlado, estratégico, libera la pasión solo con confianza", "controllato, strategico, libera la passione solo con fiducia", "kontrolliert, strategisch, lässt Leidenschaft nur mit Vertrauen frei", "contrôlé, stratégique, libère la passion seulement avec confiance"),
  Aquário: s6("imprevisível, excitado pelo diferente, resiste a rotinas", "unpredictable, excited by the different, resists routines", "impredecible, excitado por lo diferente, resiste las rutinas", "imprevedibile, eccitato dal diverso, resiste alle routine", "unberechenbar, erregt vom Anderssein, widersteht Routinen", "imprévisible, excité par le différent, résiste aux routines"),
  Peixes: s6("actua por intuição, pode sacrificar-se ou idealizar demasiado", "acts on intuition, may sacrifice or over-idealise", "actúa por intuición, puede sacrificarse o idealizar demasiado", "agisce per intuizione, può sacrificarsi o idealizzare troppo", "handelt intuitiv, kann sich opfern oder zu sehr idealisieren", "agit par intuition, peut se sacrifier ou trop idéaliser"),
}

const LUA_EMOC = {
  Carneiro: s6("precisa de independência emocional e respostas rápidas", "needs emotional independence and quick responses", "necesita independencia emocional y respuestas rápidas", "ha bisogno di indipendenza emotiva e risposte rapide", "braucht emotionale Unabhängigkeit und schnelle Reaktionen", "a besoin d'indépendance émotionnelle et de réponses rapides"),
  Touro: s6("busca estabilidade, toque físico e rotinas reconfortantes", "seeks stability, physical touch and comforting routines", "busca estabilidad, contacto físico y rutinas reconfortantes", "cerca stabilità, contatto fisico e routine confortanti", "sucht Stabilität, körperliche Nähe und tröstende Routinen", "cherche la stabilité, le contact physique et des routines réconfortantes"),
  Gémeos: s6("processa emoções falando, muda de humor com facilidade", "processes emotions by talking, shifts mood easily", "procesa emociones hablando, cambia de humor con facilidad", "elabora le emozioni parlando, cambia umore con facilità", "verarbeitet Gefühle durch Reden, wechselt leicht die Stimmung", "traite les émotions en parlant, change d'humeur facilement"),
  Caranguejo: s6("memória emocional profunda, lar é santuário", "deep emotional memory, home is sanctuary", "memoria emocional profunda, el hogar es santuario", "memoria emotiva profonda, la casa è santuario", "tiefe emotionale Erinnerung, Zuhause ist Heiligtum", "mémoire émotionnelle profonde, la maison est un sanctuaire"),
  Leão: s6("precisa de ser valorizado, ferido pelo indiferença", "needs to be valued, wounded by indifference", "necesita ser valorado, herido por la indiferencia", "ha bisogno di essere valorizzato, ferito dall'indifferenza", "muss wertgeschätzt werden, verletzt durch Gleichgültigkeit", "a besoin d'être valorisé, blessé par l'indifférence"),
  Virgem: s6("mostra cuidado com actos, ansiedade quando desordenado", "shows care through acts, anxiety when disorderly", "muestra cuidado con actos, ansiedad cuando hay desorden", "mostra cura con atti, ansia quando c'è disordine", "zeigt Fürsorge durch Taten, Angst bei Unordnung", "montre son attention par des actes, anxieux quand c'est désordonné"),
  Balança: s6("sofre com conflito, precisa de parceria equilibrada", "suffers from conflict, needs balanced partnership", "sufre con el conflicto, necesita una pareja equilibrada", "soffre per il conflitto, ha bisogno di una partnership equilibrata", "leidet unter Konflikt, braucht ausgewogene Partnerschaft", "souffre du conflit, a besoin d'un partenariat équilibré"),
  Escorpião: s6("lealdade absoluta, traição marca para sempre", "absolute loyalty, betrayal marks forever", "lealtad absoluta, la traición marca para siempre", "lealtà assoluta, il tradimento segna per sempre", "absolute Loyalität, Verrat prägt für immer", "loyauté absolue, la trahison marque à jamais"),
  Sagitário: s6("optimismo emocional, fuga quando sente prisão", "emotional optimism, escapes when feeling trapped", "optimismo emocional, huye cuando se siente atrapado", "ottimismo emotivo, fugge quando si sente intrappolato", "emotionaler Optimismus, flieht wenn er sich gefangen fühlt", "optimisme émotionnel, fuit quand il se sent enfermé"),
  Capricórnio: s6("contém sentimentos, demonstra amor com responsabilidade", "contains feelings, shows love through responsibility", "contiene sentimientos, demuestra amor con responsabilidad", "contiene i sentimenti, dimostra amore con responsabilità", "hält Gefühle zurück, zeigt Liebe durch Verantwortung", "retient ses sentiments, montre l'amour par la responsabilité"),
  Aquário: s6("distancia-se para processar, valoriza amizade emocional", "distances to process, values emotional friendship", "se distancia para procesar, valora la amistad emocional", "si distanzia per elaborare, valorizza l'amicizia emotiva", "distanziert sich zum Verarbeiten, schätzt emotionale Freundschaft", "prend de la distance pour digérer, valorise l'amitié émotionnelle"),
  Peixes: s6("absorve emoções alheias, fronteiras difusas", "absorbs others' emotions, diffuse boundaries", "absorbe emociones ajenas, límites difusos", "assorbe le emozioni altrui, confini diffusi", "absorbiert fremde Gefühle, diffuse Grenzen", "absorbe les émotions des autres, frontières floues"),
}

const MERCURIO_COM = {
  Carneiro: s6("fala directo, impaciente com rodeios", "speaks directly, impatient with detours", "habla directo, impaciente con rodeos", "parla diretto, impaziente con i giri di parole", "spricht direkt, ungeduldig mit Umwegen", "parle directement, impatient des détours"),
  Touro: s6("pensa devagar mas com solidez, teimoso nas ideias", "thinks slowly but solidly, stubborn in ideas", "piensa despacio pero con solidez, terco en las ideas", "pensa lentamente ma con solidità, testardo nelle idee", "denkt langsam aber solide, stur in Ideen", "pense lentement mais solidement, têtu dans ses idées"),
  Gémeos: s6("conversa fluida, multitarefa mental, humor rápido", "fluid conversation, mental multitasking, quick humour", "conversación fluida, multitarea mental, humor rápido", "conversazione fluida, multitasking mentale, umorismo rapido", "fließendes Gespräch, mentales Multitasking, schneller Humor", "conversation fluide, multitâche mental, humour vif"),
  Caranguejo: s6("comunica pelo tom emocional mais que pelas palavras", "communicates through emotional tone more than words", "comunica más por el tono emocional que por las palabras", "comunica più con il tono emotivo che con le parole", "kommuniziert eher durch emotionalen Ton als durch Worte", "communique davantage par le ton émotionnel que par les mots"),
  Leão: s6("expressivo, dramático, precisa de ser ouvido", "expressive, dramatic, needs to be heard", "expresivo, dramático, necesita ser escuchado", "espressivo, drammatico, ha bisogno di essere ascoltato", "ausdrucksstark, dramatisch, muss gehört werden", "expressif, dramatique, a besoin d'être entendu"),
  Virgem: s6("analítico, preciso, pode ser crítico na linguagem", "analytical, precise, can be critical in language", "analítico, preciso, puede ser crítico en el lenguaje", "analitico, preciso, può essere critico nel linguaggio", "analytisch, präzise, kann in der Sprache kritisch sein", "analytique, précis, peut être critique dans le langage"),
  Balança: s6("diplomático, evita palavras duras, busca consenso", "diplomatic, avoids harsh words, seeks consensus", "diplomático, evita palabras duras, busca consenso", "diplomatico, evita parole dure, cerca consenso", "diplomatisch, meidet harte Worte, sucht Konsens", "diplomate, évite les mots durs, cherche le consensus"),
  Escorpião: s6("silencioso até confiar, depois profundamente penetrante", "silent until trusting, then deeply penetrating", "silencioso hasta confiar, luego profundamente penetrante", "silenzioso finché non si fida, poi profondamente penetrante", "schweigsam bis Vertrauen da ist, dann tief durchdringend", "silencieux jusqu'à la confiance, puis profondément pénétrant"),
  Sagitário: s6("honesto, filosófico, pode ser tactless", "honest, philosophical, can be tactless", "honesto, filosófico, puede ser demasiado directo", "onesto, filosofico, può essere troppo diretto", "ehrlich, philosophisch, kann taktlos sein", "honnête, philosophique, peut manquer de tact"),
  Capricórnio: s6("economiza palavras, estratégico, formal", "economises words, strategic, formal", "ahorra palabras, estratégico, formal", "risparmia le parole, strategico, formale", "spart mit Worten, strategisch, formell", "économise les mots, stratégique, formel"),
  Aquário: s6("original, distanciado, debates ideias", "original, detached, debates ideas", "original, distanciado, debate ideas", "originale, distaccato, dibatte idee", "originell, distanziert, debattiert Ideen", "original, distant, débat des idées"),
  Peixes: s6("metafórico, intuitivo, dificuldade em definir limites verbais", "metaphorical, intuitive, difficulty defining verbal boundaries", "metafórico, intuitivo, dificultad para definir límites verbales", "metaforico, intuitivo, difficoltà a definire limiti verbali", "metaphorisch, intuitiv, Schwierigkeit verbale Grenzen zu setzen", "métaphorique, intuitif, difficulté à poser des limites verbales"),
}

const NODO_NORTE = {
  Carneiro: s6("evoluir para coragem individual, iniciativa própria e auto-afirmação", "evolve toward individual courage, own initiative and self-assertion", "evolucionar hacia el coraje individual, la iniciativa propia y la autoafirmación", "evolvere verso il coraggio individuale, l'iniziativa propria e l'autoaffermazione", "sich zu individuellem Mut, eigener Initiative und Selbstbehauptung entwickeln", "évoluer vers le courage individuel, l'initiative propre et l'affirmation de soi"),
  Touro: s6("evoluir para estabilidade, valor próprio e prazer encarnado", "evolve toward stability, self-worth and embodied pleasure", "evolucionar hacia la estabilidad, el valor propio y el placer encarnado", "evolvere verso stabilità, autostima e piacere incarnato", "sich zu Stabilität, Selbstwert und verkörpertem Genuss entwickeln", "évoluer vers la stabilité, l'estime de soi et le plaisir incarné"),
  Gémeos: s6("evoluir para curiosidade, diálogo e mente aberta", "evolve toward curiosity, dialogue and open mind", "evolucionar hacia la curiosidad, el diálogo y la mente abierta", "evolvere verso curiosità, dialogo e mente aperta", "sich zu Neugier, Dialog und offenem Geist entwickeln", "évoluer vers la curiosité, le dialogue et l'esprit ouvert"),
  Caranguejo: s6("evoluir para acolhimento, família emocional e vulnerabilidade", "evolve toward welcoming, emotional family and vulnerability", "evolucionar hacia el acogimiento, la familia emocional y la vulnerabilidad", "evolvere verso accoglienza, famiglia emotiva e vulnerabilità", "sich zu Aufnahme, emotionaler Familie und Verletzlichkeit entwickeln", "évoluer vers l'accueil, la famille émotionnelle et la vulnérabilité"),
  Leão: s6("evoluir para criatividade, auto-expressão e generosidade", "evolve toward creativity, self-expression and generosity", "evolucionar hacia la creatividad, la autoexpresión y la generosidad", "evolvere verso creatività, autoespressione e generosità", "sich zu Kreativität, Selbstausdruck und Großzügigkeit entwickeln", "évoluer vers la créativité, l'expression de soi et la générosité"),
  Virgem: s6("evoluir para serviço consciente, saúde e ordem útil", "evolve toward conscious service, health and useful order", "evolucionar hacia el servicio consciente, la salud y el orden útil", "evolvere verso servizio consapevole, salute e ordine utile", "sich zu bewusstem Dienst, Gesundheit und nützlicher Ordnung entwickeln", "évoluer vers le service conscient, la santé et l'ordre utile"),
  Balança: s6("evoluir para parceria equilibrada, justiça e cooperação", "evolve toward balanced partnership, justice and cooperation", "evolucionar hacia la pareja equilibrada, la justicia y la cooperación", "evolvere verso partnership equilibrata, giustizia e cooperazione", "sich zu ausgewogener Partnerschaft, Gerechtigkeit und Kooperation entwickeln", "évoluer vers le partenariat équilibré, la justice et la coopération"),
  Escorpião: s6("evoluir para profundidade, entrega emocional e transformação", "evolve toward depth, emotional surrender and transformation", "evolucionar hacia la profundidad, la entrega emocional y la transformación", "evolvere verso profondità, abbandono emotivo e trasformazione", "sich zu Tiefe, emotionaler Hingabe und Transformation entwickeln", "évoluer vers la profondeur, l'abandon émotionnel et la transformation"),
  Sagitário: s6("evoluir para significado, fé e horizontes amplos", "evolve toward meaning, faith and wide horizons", "evolucionar hacia el significado, la fe y los horizontes amplios", "evolvere verso significato, fede e orizzonti ampi", "sich zu Sinn, Glauben und weiten Horizonten entwickeln", "évoluer vers le sens, la foi et les horizons larges"),
  Capricórnio: s6("evoluir para responsabilidade, maturidade e legado", "evolve toward responsibility, maturity and legacy", "evolucionar hacia la responsabilidad, la madurez y el legado", "evolvere verso responsabilità, maturità e eredità", "sich zu Verantwortung, Reife und Vermächtnis entwickeln", "évoluer vers la responsabilité, la maturité et l'héritage"),
  Aquário: s6("evoluir para humanidade, originalidade e visão colectiva", "evolve toward humanity, originality and collective vision", "evolucionar hacia la humanidad, la originalidad y la visión colectiva", "evolvere verso umanità, originalità e visione collettiva", "sich zu Menschlichkeit, Originalität und kollektiver Vision entwickeln", "évoluer vers l'humanité, l'originalité et la vision collective"),
  Peixes: s6("evoluir para compaixão, entrega espiritual e desapego", "evolve toward compassion, spiritual surrender and detachment", "evolucionar hacia la compasión, la entrega espiritual y el desapego", "evolvere verso compassione, abbandono spirituale e distacco", "sich zu Mitgefühl, spiritueller Hingabe und Loslösung entwickeln", "évoluer vers la compassion, l'abandon spirituel et le détachement"),
}

const NODO_SUL = {
  Carneiro: s6("zona de conforto: dependência do outro para agir; padrão de passividade ou projeção de liderança", "comfort zone: dependence on other to act; pattern of passivity or projected leadership", "zona de confort: dependencia del otro para actuar; patrón de pasividad o proyección de liderazgo", "zona di comfort: dipendenza dall'altro per agire; schema di passività o leadership proiettata", "Komfortzone: Abhängigkeit vom anderen zum Handeln; Muster von Passivität oder projizierter Führung", "zone de confort : dépendance à l'autre pour agir ; schéma de passivité ou de leadership projeté"),
  Touro: s6("zona de conforto: possessividade, apego material ou resistência à mudança", "comfort zone: possessiveness, material attachment or resistance to change", "zona de confort: posesividad, apego material o resistencia al cambio", "zona di comfort: possessività, attaccamento materiale o resistenza al cambiamento", "Komfortzone: Besitzdenken, materielle Bindung oder Widerstand gegen Veränderung", "zone de confort : possessivité, attachement matériel ou résistance au changement"),
  Gémeos: s6("zona de conforto: superficialidade, dispersão ou fuga emocional pela mente", "comfort zone: superficiality, scattering or emotional escape through mind", "zona de confort: superficialidad, dispersión o escape emocional por la mente", "zona di comfort: superficialità, dispersione o fuga emotiva tramite la mente", "Komfortzone: Oberflächlichkeit, Zerstreutheit oder emotionaler Flucht durch den Geist", "zone de confort : superficialité, dispersion ou fuite émotionnelle par l'esprit"),
  Caranguejo: s6("zona de conforto: dependência emocional, vitimização ou ficar preso ao passado", "comfort zone: emotional dependence, victimhood or stuck in past", "zona de confort: dependencia emocional, victimización o quedarse atrapado en el pasado", "zona di comfort: dipendenza emotiva, vittimismo o restare bloccati nel passato", "Komfortzone: emotionale Abhängigkeit, Opferrolle oder Festhalten in der Vergangenheit", "zone de confort : dépendance émotionnelle, victimisation ou blocage dans le passé"),
  Leão: s6("zona de conforto: orgulho ferido, drama ou necessidade de controlo", "comfort zone: wounded pride, drama or need for control", "zona de confort: orgullo herido, drama o necesidad de control", "zona di comfort: orgoglio ferito, dramma o bisogno di controllo", "Komfortzone: verletzter Stolz, Drama oder Kontrollbedürfnis", "zone de confort : fierté blessée, drame ou besoin de contrôle"),
  Virgem: s6("zona de conforto: crítica excessiva, perfeccionismo paralisante", "comfort zone: excessive criticism, paralysing perfectionism", "zona de confort: crítica excesiva, perfeccionismo paralizante", "zona di comfort: critica eccessiva, perfezionismo paralizzante", "Komfortzone: übermäßige Kritik, lähmender Perfektionismus", "zone de confort : critique excessive, perfectionnisme paralysant"),
  Balança: s6("zona de conforto: codependência, evitar conflito a qualquer custo", "comfort zone: codependency, avoiding conflict at any cost", "zona de confort: codependencia, evitar el conflicto a cualquier precio", "zona di comfort: codependenza, evitare il conflitto a ogni costo", "Komfortzone: Co-Abhängigkeit, Konflikt um jeden Preis vermeiden", "zone de confort : codépendance, éviter le conflit à tout prix"),
  Escorpião: s6("zona de conforto: manipulação, ciúme, vingança ou poder oculto", "comfort zone: manipulation, jealousy, revenge or hidden power", "zona de confort: manipulación, celos, venganza o poder oculto", "zona di comfort: manipolazione, gelosia, vendetta o potere occulto", "Komfortzone: Manipulation, Eifersucht, Rache oder verborgene Macht", "zone de confort : manipulation, jalousie, vengeance ou pouvoir caché"),
  Sagitário: s6("zona de conforto: arrogância, fuga, promessas vazias", "comfort zone: arrogance, escape, empty promises", "zona de confort: arrogancia, huida, promesas vacías", "zona di comfort: arroganza, fuga, promesse vuote", "Komfortzone: Arroganz, Flucht, leere Versprechen", "zone de confort : arrogance, fuite, promesses vides"),
  Capricórnio: s6("zona de conforto: frieza, status, workaholic sem alma", "comfort zone: coldness, status, soulless workaholism", "zona de confort: frialdad, estatus, workaholic sin alma", "zona di comfort: freddezza, status, workaholic senza anima", "Komfortzone: Kälte, Status, seelenloser Workaholic", "zone de confort : froideur, statut, workaholic sans âme"),
  Aquário: s6("zona de conforto: distanciamento, rebeldia vazia, frieza emocional", "comfort zone: detachment, empty rebellion, emotional coldness", "zona de confort: distanciamiento, rebeldía vacía, frialdad emocional", "zona di comfort: distacco, ribellione vuota, freddezza emotiva", "Komfortzone: Distanz, leerer Rebellion, emotionale Kälte", "zone de confort : distance, rébellion vide, froideur émotionnelle"),
  Peixes: s6("zona de conforto: ilusão, escapismo, sacrifício martírio", "comfort zone: illusion, escapism, martyrdom sacrifice", "zona de confort: ilusión, escapismo, sacrificio martirial", "zona di comfort: illusione, evasione, sacrificio martiriale", "Komfortzone: Illusion, Eskapismus, Märtyreropfer", "zone de confort : illusion, évasion, sacrifice martyr"),
}
