...
export const LandingPremiumPaywall = forwardRef(function LandingPremiumPaywall({
  ...
  return (
    <section
      ...
      className="landing-premium-paywall landing-premium-paywall--simple landing-glass"
      aria-label={t('landing.funnel.paywallAria')}
    >
      <header className="landing-premium-paywall__simple-head">
        <h2 className="landing-premium-paywall__simple-title">{t('landing.funnel.paywallSimpleTitle')}</h2>
        <p className="landing-premium-paywall__simple-lead">{t('landing.funnel.paywallSimpleLead')}</p>
      </header>
      ...
      <div className="landing-premium-paywall__simple-form">
        ...
        <LandingSimpleCtaButton
          className="landing-premium-paywall__cta landing-premium-paywall__cta--simple"
          onClick={onSubmit}
          disabled={carregando || !recaptchaOk}
          loading={carregando}
          ariaLabel={t('landing.funnel.paywallSimpleCta')}
          pulse
        >
          {t('landing.funnel.paywallSimpleCta')}
        </LandingSimpleCtaButton>
        ...
        <p className="landing-premium-paywall__premium-note">{t('landing.funnel.paywallPremiumNote')}</p>
      </div>
    </section>
  )
})
