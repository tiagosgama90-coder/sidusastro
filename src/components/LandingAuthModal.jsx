...
function PasswordField({
  ...
  return (
    <div className="landing-auth-field landing-auth-password-block" style={style}>
...
export function LandingAuthModal({
  ...
  registerSenha = '',
  setRegisterSenha,
  registerSenhaConfirm = '',
  setRegisterSenhaConfirm,
  registerVerSenha = false,
  setRegisterVerSenha,
  registerVerSenhaConfirm = false,
  setRegisterVerSenhaConfirm,
  recaptchaOk = false,
  setRecaptchaOk,
  recaptchaKey = 0,
  registerErro = null,
  ...
  return (
    <div
      className={`landing-auth-modal${isRegister ? ' landing-auth-modal--register' : ''}`}
      role="dialog"
      aria-modal="true"
      ...
      <div className={`landing-auth-modal__panel${isRegister ? ' landing-auth-modal__panel--register' : ''}`}>
        ...
        {(!emRecuperacao || isRegister) && (
          <PasswordField
            ...
            verSenha={activeVerSenha}
            setVerSenha={setActiveVerSenha}
            autoComplete={isRegister ? 'new-password' : 'current-password'}
            onEnter={handlePrimary}
            style={{ marginBottom: isRegister ? 12 : 20 }}
          />
        )}
        ...
        {isRegister && (
          <PasswordField
            ...
            verSenha={registerVerSenhaConfirm}
            setVerSenha={setRegisterVerSenhaConfirm}
